...
$obj->evreg($name,$address,$pincode,$district,$city,$vehicleno,$contactno,$email,$password);
}
else
echo"<script>alert('Password is empty')</script>";
	...
	echo"<script>alert('vehicle number is empty')</script>";
}
else
